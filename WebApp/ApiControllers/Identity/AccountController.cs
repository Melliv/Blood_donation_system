...
namespace WebApp.ApiControllers.Identity
{
    ...
    public class AccountController : ControllerBase
    {
            ...
            ILogger<AccountController> logger, IConfiguration configuration, IMapper mapper)
        {
            ...
            _appUserMapper = new AppUserMapper(mapper);
        }
        ...
        [ProducesResponseType(typeof(DTO.App.V1.AppUser), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        public async Task<ActionResult<DTO.App.V1.AppUser>> GetAppUserInfo()
        {
            return Ok(_appUserMapper.Map(await _userManager.GetUserAsync(User)));
        }
